...
public class Mapa extends JPanel {
	...
	// Estou assumindo que a classe territorio tem um nome e um poligono definindo sua área de clique.
	{
		...
		lstTerritorios.add( new Territorio("Austrália", new Ponto[] {
			...
			public void mouseClicked(MouseEvent e) {
				...
				for(Territorio t : lstTerritorios) {
					...
					if(t.getPoligono().contains(e.getX(), e.getY())) {
						...
						JFrame paisClicado = new JFrame("País Clicado");
						
						JOptionPane.showMessageDialog(paisClicado, t.getTerritorio()+"\nExércitos: "+t.getExercitos(),"País Clicado",JOptionPane.PLAIN_MESSAGE);
					}
				}
